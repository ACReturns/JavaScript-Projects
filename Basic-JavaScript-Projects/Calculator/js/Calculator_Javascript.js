...
const Calculator =
{
    // Display 0 on the calculator screen
    Display_Value: '0',
    // This will hold the first operand for any expressions, we set it to null for now
    First_Operand: null,
    // This checks if the second operand has been input or not
...
function Input_Digit(digit)
{
    ...
    /* This checks to see if Wait_Second_Operand is true and sets Display_Value
...
function Input_Decimal(dot)
{
    ...
    {
        // If the Display_Value does not contain a decimal point then we want to add a decimal point
...
function Handle_Operator(Next_Operator)
{
    ...
    /* Check if an operator already exists and if Wait_Seconf_Operand is true, then
